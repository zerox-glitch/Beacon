...
const ART_PRESETS: Preset[] = [
  ...
  art({
    ...
    category: "Gallery",
    featured: true,
    artUrl: "/samples/psychedelic.jpg",
    style: {
      moduleShape: "dots",
      eyeShape: "extra-rounded",
      ballShape: "circle",
...
export const SAMPLE_IMAGES: { id: string; name: string; src: string }[] = [
  ...
  { id: "geisha", name: "Geisha", src: "/samples/geisha.jpg" },
  { id: "mecha", name: "Mecha", src: "/samples/mecha.jpg" },
  { id: "fungi", name: "Fungi", src: "/samples/fungi.jpg" },
  { id: "psychedelic", name: "Swirl", src: "/samples/psychedelic.jpg" },
  { id: "pagoda", name: "Pagoda", src: "/samples/pagoda.jpg" },
  { id: "nebula", name: "Nebula", src: "/samples/nebula.jpg" },
